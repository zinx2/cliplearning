...
- (NSURLRequest *)requestDefaultWithTemplate:(KMTTemplate *)_template error:(NSError **)error;
...
- (NSURL *)sharerURLWithTemplate:(KMTTemplate *)_template error:(NSError **)error;
