...
public class AgeAuthManager {
     ...
     * @return status code
     * @deprecated replaced by {@link #requestShowAgeAuthDialog(Bundle, Activity, boolean)}
     */
    @Deprecated
    public int requestShowAgeAuthDialog(final Context context, final Bundle ageAuthParams) {
        ...
        return requestShowAgeAuthDialog(ageAuthParams, activity, Utility.isUsablePermission(context, Manifest.permission.RECEIVE_SMS));
    }
     ...
     * @return status code
     */
    public int requestShowAgeAuthDialog(final Bundle ageAuthParams, final Activity activity, final boolean useSmsReceiver) {
    ...
    public int requestShowAgeAuthDialog(final AgeAuthParamBuilder builder, final boolean useSmsReceiver) {
        final Activity activity = KakaoSDK.getCurrentActivity();
        return requestShowAgeAuthDialog(builder.build(), activity, useSmsReceiver);
    }
