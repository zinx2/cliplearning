...
public class AppActionInfoBuilder {
     ...
     * @return 계속해서 앱 연결 설정할 수 있는 빌더를 반환한다.
     */
    public AppActionInfoBuilder setExecuteParam(final Map<String, String> executeParam) {
        this.executeParam = Utility.buildQueryString(executeParam);
        return this;
    }
     ...
     * @return 계속해서 앱 연결 설정할 수 있는 빌더를 반환한다.
     */
    public AppActionInfoBuilder setMarketParam(final Map<String, String> marketParam) {
        this.marketParam = Utility.buildQueryString(marketParam);
        return this;
    }
