...
public class FriendsRequest extends ApiRequest {
    ...
    public Uri.Builder getUriBuilder() {
        return super.getUriBuilder().path(ServerProtocol.GET_FRIENDS_PATH)
                .appendQueryParameter(StringSet.friend_type, friendType.name)
                .appendQueryParameter(StringSet.friend_filter, friendFilter.name)
                .appendQueryParameter(StringSet.friend_order, friendOrder.name)
