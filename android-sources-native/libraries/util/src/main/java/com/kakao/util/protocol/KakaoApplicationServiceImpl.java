...
class KakaoApplicationServiceImpl implements KakaoProtocolService {
    ...
    private boolean validateTalkPackagName(String packageName) {
    ...
    private boolean validateTalkAuthenticity(final Context context, final String packageName, final int minVersion) {
        ...
        try {
            ...
            return validateTalkMinVersion(talkPackageInfo, minVersion) && validateTalkPackagName(packageName) && validateTalkSignature(talkPackageInfo);
