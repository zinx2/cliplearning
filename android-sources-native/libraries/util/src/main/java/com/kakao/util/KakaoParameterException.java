...
public class KakaoParameterException extends Exception {
     ...
     * @return {@link KakaoParameterException.ERROR_CODE} 중 하나
     */
    ...
    public KakaoParameterException(final String message) {
        super(message);
    }

    public KakaoParameterException(final ERROR_CODE code, final String e) {
        super(e);
        this.code = code;
    }

    public KakaoParameterException(final ERROR_CODE code, final Exception e) {
        super(e);
        this.code = code;
    }
