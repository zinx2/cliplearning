...
public class CheckStoryUserResponse extends JSONObjectResponse {
    ...
    public CheckStoryUserResponse(ResponseData responseData) throws ResponseBodyException, ApiResponseStatusError {
        super(responseData);
        this.isStoryUser = body.getBoolean(StringSet.isStoryUser);
    }
