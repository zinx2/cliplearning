...
public class RegisterPushTokenResponse extends PrimitiveTypeResponse {
    ...
    public RegisterPushTokenResponse(ResponseData responseData) throws ResponseBodyException, ApiResponseStatusError {
        super(responseData);

        this.expiredAt = Integer.valueOf(new String(responseData.getData()));
    }
