...
public class KakaoLinkMainActivity extends Activity {
    ...
    private void initializeView() {
        ...
        forwardable = findViewById(R.id.forwardable);

        findViewById(R.id.forwardable_box).setOnClickListener(v -> forwardable.toggle());
    ...
    private void addListenerOnClearButton() {
        ...
        clearButton.setOnClickListener(v -> new DialogBuilder(KakaoLinkMainActivity.this)
