...
public class KakaoLInkTestHelper {
    ...
    public static ResponseData createMockResponseData() {
        ...
        try {
            templateMsg.put(KakaoTalkLinkProtocol.P, new JSONObject());
            templateMsg.put(KakaoTalkLinkProtocol.C, new JSONObject());
            object.put(KakaoTalkLinkProtocol.TEMPLATE_ID, "9999");
            object.put(KakaoTalkLinkProtocol.TEMPLATE_ARGS, templateMsg);
